      ...
      <div class="course-info">
        ...
        <div class="wrap-right">
          ...
          <p class="data">
            ...
            }}课时/{{ course_info.publish_sections }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{ course_info.level_name }}</p>
          <div class="sale-time">
          ...
          <div class="tab-item" v-if="tabIndex===2">
            ...
            <div class="chapter-item" v-for="chapter in course_chapters" :key="chapter.name">
              ...
              <ul class="section-list">
                <li class="section-item" v-for="section in chapter.course_sections" :key="section.name">
                  <p class="name"><span class="index">{{ chapter.chapter }}-{{ section.ordering }}</span>
...
export default {
        ...
        sources: [
          {
            ...
            src: "http://rpi0lbxi1.hn-bkt.clouddn.com/media/kerry.mp4",//视频地址
          },
        ],
  ...
  methods: {
    ...
    get_chapter() {
      // 获取当前课程对应的章节课时信息
      // http://127.0.0.1:8000/course/chapter/?course=(pk)
      this.$axios.get(`${this.$settings.base_url}/course/chapter/`, {
        ...
        // console.log('course_chapters', this.course_chapters);
      }).catch(error => {
