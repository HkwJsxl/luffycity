    ...
    <div class="main">
      ...
      <div class="course_pagination block">
        <el-pagination
            ...
            :current-page.sync="filter.latest_id"
            :page-sizes="[2, 3, 5, 10]"
...
export default {
  ...
  methods: {
    handleSizeChange(val) {
      ...
      this.filter.latest_id = this.filter.limit;
    },
    ...
    get_course() {
      ...
      if (this.filter.limit > 0) {
        filters.limit = this.filter.limit;
      } else {
        filters.limit = 5;
      }

      // 设置当前页码
      if (this.filter.latest_id > 3) {
        filters.latest_id = this.filter.latest_id;
      } else {
        filters.latest_id = 3;
      }
